<div class="row">
	...
	<div class="col-md-6 number-keypad" >
		<div id="calculator" name="calculator">
			<div class="row text-center" id="calc">
				<div class="calcBG col-md-12 text-center">
					...
					<div class="row">
						<button id="1" type="button" class="btn btn-color" onclick="calEnterValue(this.id, {{ $row_index }})">1</button>
					...
					<div class="row">
						...
						<button id="clear" type="button" class="btn btn-warning" onclick="clearScreenVal({{ $row_index }})">CE</button>
					</div>
				</div>
			</div>
		</div>
