        ...
        <div class="col-md-6">
            ...
            @if(!empty($pos_settings['inline_service_staff']))
                <button type="button" id="show_service_staff_availability" title="{{ __('lang_v1.service_staff_availability') }}" class="btn btn-primary btn-flat m-6 btn-xs m-5 pull-right" data-container=".view_modal"
                        data-href="{{ action('SellPosController@showServiceStaffAvailibility')}}">
            ...
            @if(in_array('packages', $enabled_modules))
                <a href="{{route('packages')}}" title="packages" data-placement="bottom" class="btn bg-primary btn-flat m-6 btn-xs m-5  pull-right" style="color: white">
                    <i class="fa fas fa-box"></i> <strong>Packages</strong>
                </a>
                <input type="hidden" id="enable_packages_module" value="true" >
            @endif
